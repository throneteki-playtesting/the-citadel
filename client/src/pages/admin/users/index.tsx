                        ...
                        <div className="flex flex-wrap gap-1">
                            {user.roles.map((role) => {
                                ...
                                return (
                                    <div
                                        key={role.discordId}
                                        className={classNames("border py-1 px-2 rounded-md text-sm", {
                                            "border-content3": !hex
                                        })}
                                        style={
                                            hex
        ...
        <div className="space-y-2">
            <div className="px-4 md:px-0 space-y-2">
                ...
                <div className="text-sm md:text-base">
                    User data is synced with Discord, prioritising the linked discord server information.
                </div>
                <div className="text-sm md:text-base">
                    You may edit user permissions at a granular level here, or at a broader level via the Roles page.
                </div>
            </div>
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between border border-content2 rounded-lg p-4">
                    <div className="space-y-1">
                        ...
                        <div className="text-xs text-default-500">
                            Defines the default permissions granted to all authenticated users, on top of their
                            individual and role-based permissions.
                        </div>
                    </div>
                ...
                bottomContent={
                    <div className="px-4">
                        <Pagination
                            page={page}
                            onChange={setPage}
                            total={Math.max(1, Math.ceil((usersData?.total ?? 0) / perPage))}
                        />
                    </div>
                }
            >
                ...
                <TableBody
                    emptyContent="No users from discord server have logged into site"
