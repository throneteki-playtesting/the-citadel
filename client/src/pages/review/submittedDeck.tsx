...
export default function SubmitDecks({ card, decks: initial = [], onValueChange: onDecksChange }: SubmitDecksProps) {
    ...
    const onRemoveDeck = useCallback((url: DeckLink | DecklistLink) => {
    ...
    return (
        <div className="space-y-2">
            ...
            <div className="text-sm md:text-base font-sans">Provide at least one <a href="https://thronesdb.com/" target="_blank" className="text-primary hover:brightness-75">ThronesDB</a> deck in which you playtested this card. For private decks, please ensure you have "Share your decks" checked in account settings.</div>
    ...
    if (!deck) {
        return (
            <div className="relative border border-danger/30 bg-danger/10 rounded-lg p-3 animate-pulse">
                ...
                <div className="font-crimson italic text-sm md:text-base text-danger/80">A previously submitted deck can no longer be found — it has likely been cast aside or deleted. Please delete, or submit a new one.</div>
        ...
        <div className="border border-content2 p-2">
            ...
            <div className="flex gap-1 p-1">
                <div className="shrink-0">
                    <CardStack cards={[...deck.agendas, deck.faction]} tilt={{ amount: -0.2, depth: (14 / deck.agendas.length) }} className="w-24 md:w-32" shadow={false}>
