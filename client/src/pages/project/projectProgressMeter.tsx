...
export default function ProjectProgressMeter({ className, style, project }: ProjectProgressMeterProps) {
    ...
    if (error) {
        return <ProgressUnavailable className={className} style={style} reason={getErrorMessage(error)} size="lg" />;
    }
