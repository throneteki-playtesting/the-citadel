...
const steps: { icon: IconDefinition; title: string; description: React.ReactNode }[] = [
    {
        ...
        description: (
            <>
                Build one on{" "}
                <Link href={THRONESDB_URL} target="_blank" rel="noreferrer" className="text-[length:inherit]">
                    ThronesDB
                </Link>
                , or grab one from a card's page on this site.
            </>
        )
    },
    {
                        ...
                        <ModalBody className="pb-4 sm:pb-6">
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center gap-2 border border-content3 bg-content2 rounded-lg p-3 mt-1">
                                <div className="flex-1 text-sm text-foreground/70">
                                    Short on time? Share your initial impressions with a review — games are preferred,
                                    but not required.
                                </div>
                                <Button
                                    as={Link}
                            ...
                            <div className="text-xs text-foreground/60 text-center">
                                ...
                                <span className="font-semibold">#playtest-chat</span> on Discord.
                            </div>
                        </ModalBody>
                    </>
                )}
